...
#define cantOpcionesPrincipal 3
...
int main()
{
   ...
   while(strcmp(operatoro, "si") == 0){
    ...
    while ( operar < 1 || operar > cantOpcionesPrincipal ) {
...
default:
    ...
    gets(operatoro);
        ...
        while(strcmp(operatoro, "si") != 0 && strcmp(operatoro, "no") != 0){
        ...
        if(strcmp(operatoro, "no") == 0){

            saludoFinal(operatoro);
        }
   }
...
void funcionAstronautas(){
    ...
    while(strcmp(valor, "si") == 0)
    {
        ...
        while ( operador < 1 || operador > cantidadOpcionesAstro ) {
